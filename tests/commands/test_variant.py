"""
Test the 'commands.variant' module.
"""
...
def test_variant_command_basic():
    """Test basic usages of the 'variant' command."""

    args = [PKG_NAME, "variant"]

    # Use a temporary directory for state.
    with override_environ_tempdir("XDG_STATE_HOME"):
        assert rcmpy_main(args) == 0
        assert rcmpy_main(args + ["test"]) == 0
